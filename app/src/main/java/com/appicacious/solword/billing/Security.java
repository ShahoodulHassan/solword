...
class Security {
    ...
    static boolean verifyPurchase(String base64PublicKey, String signedData,
        ...
        if (TextUtils.isEmpty(signedData) || TextUtils.isEmpty(base64PublicKey)
            ...
            Log.w(TAG, "verifyPurchase: Purchase verification failed: missing data.");
//            BillingHelper.logWarn(TAG, "Purchase verification failed: missing data.");
    ...
    public static PublicKey generatePublicKey(String encodedPublicKey) throws IOException {
        try {
            ...
            Log.w(TAG, "generatePublicKey: " + msg);
//            BillingHelper.logWarn(TAG, msg);
    ...
    public static boolean verify(PublicKey publicKey, String signedData, String signature) {
        ...
        try {
            ...
            Log.w(TAG, "verify: Base64 decoding failed.");
//            BillingHelper.logWarn(TAG, "Base64 decoding failed.");
        ...
        try {
            ...
            if (!signatureAlgorithm.verify(signatureBytes)) {
                Log.w(TAG, "verify: Signature verification failed.");
//                BillingHelper.logWarn(TAG, "Signature verification failed.");
            ...
            Log.w(TAG, "verify: Invalid key specification.");
//            BillingHelper.logWarn(TAG, "Invalid key specification.");
        } catch (SignatureException e) {
            Log.w(TAG, "verify: Signature exception.");
